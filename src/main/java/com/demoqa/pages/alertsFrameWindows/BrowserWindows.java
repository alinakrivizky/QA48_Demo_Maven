...
List<String> tabs=new ArrayList<>(driver.getWindowHandles());//получение ID всех открытых окон
driver.switchTo().window(tabs.get(index));//обращение к конкретному окну
